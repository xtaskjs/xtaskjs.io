...
const esTranslations: Record<string, string> = {
  ...
  "Detailed reference for core, common, adapters, TypeORM, security, mailer, internationalization, scheduler, cache, and queues.": "Referencia detallada de core, common, adaptadores, TypeORM, security, mailer, internationalization, scheduler, cache y queues.",
